...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 bg-light border-bottom shadow-sm " >
  <h5 class="my-0 font-weight-bold navbar" ><strong><a href="/">{{config('app.name', 'JobsFinder')}}</a></strong></h5>
  <nav class="col-md-7 col-sm-8 navbar-item">
    <a class="col-md-4 col-sm-4 text-dark text-font"  href="/category">Categories</a>
    <a class="col-md-4 col-sm-4 text-dark text-font"  href="#">about</a>
